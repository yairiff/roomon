...
export function LiveIcon() {
  return <OnlinePredictionRoundedIcon fontSize="small" />;
}

export function ChevronLeftIcon() {
  return <ChevronLeftRoundedIcon fontSize="small" />;
}

export function ChevronRightIcon() {
  return <ChevronRightRoundedIcon fontSize="small" />;
}
...
export function LessonTypeIcon() {
  return <SchoolRoundedIcon fontSize="large" />;
}

export function ReservationIcon() {
  return <EventAvailableRoundedIcon fontSize="large" />;
}
...
export function ClosedIcon() {
  return <BlockRoundedIcon fontSize="large" />;
}

export function MenuIcon() {
  return <MenuRoundedIcon fontSize="small" />;
}
